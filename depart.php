        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="row">
                    ...
                    <a href="adddepart.php" class="btn btn-success mb-3 ">เพิ่มแผนก</a>
                        <div class="card">
                            
                            <h5 class="card-header">แผนก </h5>
                            <div class="card-body">
          ...
          while($row =$select_stml->fetch(PDO::FETCH_ASSOC)){
            ?>
                                          <tr>
                                            ...
                                            <td><a href="editdepart.php?update_id=<?php  echo $row["DepartmentID"];  ?>" class="btn btn-sm btn-warning">แก้ไข</a></td>
