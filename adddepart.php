            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="row">
                    <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                        <div class="card">
                            <h5 class="card-header">เพิ่มแผนก</h5>
                            <div class="card-body">
                            <?php 
         if (isset($errorMsg)) {
    ?>
    ...
    <form method="post" class="form-horizontal mt-5">
            ...
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txt_departmentid" class="form-control" placeholder="เพิ่ม รหัสแผนก...">
                    </div>
                </div>
            </div>
            <br>
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txt_departmentname" class="form-control" placeholder="เพิ่ม ชื่อแผนก...">
                    </div>
                </div>
            </div>
            <div class="form-group text-center">
