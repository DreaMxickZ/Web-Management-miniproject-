...
$showselect_stmt=$db->prepare("SELECT (DepartmentID) FROM department ");
    ...
    if (isset($_REQUEST['btn_insert'])) {
        ...
        if (empty($EmployeeID)) {
              $errorMsg = "กรุณาเพิ่ม รหัสพนักงาน";
        } else if (empty($Title)) {
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="employ">Employee</a>  </li>
    ...
    <?php } ?>
            ...
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txt_employeeid" class="form-control" placeholder="เพิ่ม รหัสพนักงาน...">
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txt_name" class="form-control" placeholder="เพิ่ม ชื่อ - นามสกุล...">
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="form-group text-center">
                <div class="row">
                    <label for="salary" class="col-sm-3 control-label">เริ่มทำงาน</label>
                    <div class="col-sm-9">
            ...
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txt_salary" class="form-control" placeholder="เพิ่ม เงินเดือน...">
                    </div>
                </div>
            </div>
            <br>
